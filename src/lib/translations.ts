...
> = {
  en: {
    ...
    home: {
      ...
      heroSubtitle:
        "Just speak naturally, and Ollo instantly creates your transaction. The fastest way to track money.",
      ...
      spotlightSubtitle:
        "The fastest way to track expenses. Just speak naturally in your language, and Ollo's AI instantly understands amount, category, and details.",
      ...
      featuresSubtitle:
        "Powerful features designed with simplicity in mind. Track, analyze, and optimize your spending effortlessly.",
      viewAllFeatures: "View All Features →",
      smartTransactionsTitle: "Smart Transactions",
      smartTransactionsDesc:
        "Track income, expenses, and transfers with powerful categorization and search.",
      multiWalletTitle: "Multi-Wallet",
      multiWalletDesc:
        "Manage cash, bank accounts, e-wallets, and crypto all in one place.",
      ...
      beautifulDesignDesc:
        "Modern, clean interface that makes finance tracking a joy.",
      freeForeverTitle: "Free Forever Core",
      freeForeverDesc:
        "Essential features are free. Premium unlocks the full experience.",
    ...
    features: {
      ...
      subtitle:
        "Everything you need to take control of your finances. Track expenses, analyze spending, and build better money habits.",
      premium: "Premium",
      ...
      transactionManagementDesc:
        "Add income, expense, and transfer transactions with ease. Edit date, time, amount, category, and notes. Search and filter your complete transaction history. Swipe to delete with undo support.",
      multiWalletSystem: "Multi-Wallet System",
      multiWalletSystemDesc:
        "Create unlimited wallets for Cash, Bank accounts, E-Wallets, and Crypto. Transfer between wallets with fee tracking. Balance tracking per wallet with color customization.",
      statisticsAnalytics: "Statistics & Analytics",
      statisticsAnalyticsDesc:
        "Weekly, monthly, and yearly views with beautiful charts. Category breakdown pie charts, income vs expense comparisons, and average daily spending calculations.",
      budgetManagement: "Budget Management",
      budgetManagementDesc:
        "Set monthly budgets per category with progress tracking and visual indicators. Get over-budget warnings and review your budget history.",
      savingsGoals: "Savings Goals",
      savingsGoalsDesc:
        "Create savings goals with target amounts. Deposit or withdraw with quick percentage shortcuts (5%, 10%, 25%, 50%). Visual progress tracking with target date countdown.",
      billsRecurring: "Bills & Recurring",
      billsRecurringDesc:
        "Never miss a payment with bill reminders. Multiple reminder offsets (1 day, 3 days, 1 week before). Set up recurring transactions weekly, monthly, or yearly.",
      debtTracker: "Debt Tracker",
      debtTrackerDesc:
        "Track money you owe (Payable) and money owed to you (Receivable). Partial payment support with payment history and due date reminders.",
      wishlist: "Wishlist",
      wishlistDesc:
        "Add items you want to buy with priority levels. Track target prices and mark as purchased — automatically creates a transaction.",
      cardGallery: "Card Gallery",
      cardGalleryDesc:
        "Beautiful visual card collection for Bank, E-Wallet, and Blockchain cards. Masked card number display, expiry tracking, and custom card designs.",
      reimbursementTracker: "Reimbursement Tracker",
      reimbursementTrackerDesc:
        "Track business expenses to claim back. Status tracking (Pending, Approved, Paid) linked to original transactions.",
    ...
    pricing: {
      ...
      title2: "no surprises",
      subtitle:
        "Start free, upgrade when you need more. All plans include core features to manage your money better.",
      free: "Free",
      monthly: "Monthly",
      sixMonth: "6-Month",
      annual: "Annual",
    ...
    download: {
      ...
      iosComingSoonDesc:
        "We're working on bringing Ollo to iPhone. Follow us on social media for updates.",
    ...
    faq: {
      ...
      title2: "Questions",
      subtitle:
        "Find answers to common questions about Ollo. Can't find what you're looking for? Contact us!",
    ...
    about: {
      ...
      title2: "Ollo",
      subtitle:
        "A personal finance app built with care, designed to help everyone build better money habits.",
      missionTitle: "Our Mission",
      missionText:
        "Money tracking shouldn't be stressful. It should be simple, fast, and human.",
      missionDesc:
        "We believe that everyone deserves a clear view of their finances without complexity or overwhelm. Ollo was created to be the finance companion that respects your time, protects your privacy, and helps you make smarter decisions about your money — every single day.",
      ...
      userFocusedDesc:
        "Every feature is built based on real user needs. We listen to feedback and continuously improve the experience.",
      sustainable: "Sustainable",
      sustainableDesc:
        "We offer a generous free tier and fair pricing. Building something that lasts means building something sustainable.",
      createdBy: "Created by",
      at: "at",
      developerBio:
        "Indie developer and maker passionate about building useful tools that help people in their daily lives. Ollo is a labor of love, crafted with attention to detail and a commitment to quality.",
    ...
    credits: {
      ...
      title2: "Open Source",
      subtitle:
        "Ollo is built on the shoulders of giants. We gratefully acknowledge the incredible tools and libraries that make this project possible.",
    ...
    roadmap: {
      ...
      vipCodeSystemDesc:
        "Exclusive badges and premium access for special users. Redeem VIP codes for unique perks and recognition.",
      freemiumQuickRecord: "Freemium Quick Record",
      freemiumQuickRecordDesc:
        "Free users now get 15 free uses each for Voice and Scan Quick Record features.",
      premiumColorThemes: "Premium Color Themes",
      premiumColorThemesDesc:
        "6 exclusive color themes for premium users to customize their app experience.",
      keyboardAutoCapitalization: "Keyboard Auto-Capitalization",
      keyboardAutoCapitalizationDesc:
        "Smart text capitalization for names and sentences in input fields.",
      appRestartBackupRestore: "App Restart on Backup Restore",
      appRestartBackupRestoreDesc:
        "Automatic app restart after restoring backup for seamless data recovery.",
      billDebtReminders: "Smart Reminders",
      billDebtRemindersDesc:
        "Never miss a payment with custom date/time reminders for bills and debts.",
      globalCurrencySupport: "Global Currency Support",
      globalCurrencySupportDesc:
        "Support for 160+ currencies with real-time exchange rates and smart sorting.",
      onboardingGateway: "Onboarding Gateway",
      onboardingGatewayDesc:
        "Redesigned welcome experience with integrated backup restoration for returning users.",
      themeSelectionScreen: "Advanced Theme Control",
      themeSelectionScreenDesc:
        "Dedicated theme selection with separate preferences for Light/Dark mode card styles.",
      darkModeCardThemes: "Dark Mode Card Themes",
      darkModeCardThemesDesc:
        "10 stunning new dark mode card themes including Nova, Eclipse, and Aurora.",
      menuAppearanceSystem: "Menu Appearance System",
      menuAppearanceSystemDesc:
        "Personalize your experience with 28 new preset color themes for dashboard menu icons.",
      performanceOptimizations: "Performance & Polish",
      performanceOptimizationsDesc:
        "Faster startup, optimized database queries, and over 138+ UI refinements for a smoother experience.",
      backupSystemRedesign: "Backup System Redesign",
      backupSystemRedesignDesc:
        "Seamless backup experience using system share sheet without requiring special storage permissions.",
      categoryReorder: "Category Reorder",
      categoryReorderDesc:
        "Customize category order with drag & drop in Category Management.",
      nullSafety: "ID Null-Safety",
      nullSafetyDesc:
        "Global enforcement of ID validation to prevent data anomalies.",
      performancePro: "Performance Pro",
      performanceProDesc:
        "Major overhaul for 60fps scrolling on heavy lists using RepaintBoundary.",
      multiPhoto: "Multi-Photo Attachments",
      multiPhotoDesc:
        "Support for multiple photo attachments per transaction (Premium).",
      repaymentModule: "Repayment Module",
      repaymentModuleDesc:
        "Specialized UI for credit card repayments and tracking.",
      import2: "Import 2.0",
      import2Desc: "Smarter CSV processing with pre-import category mapping.",
      edgeToEdge: "Edge-to-Edge Support",
      edgeToEdgeDesc:
        "Native Android 15 UI support with bottom-to-top transparency.",
      glassmorphism: "Glassmorphism UI",
      glassmorphismDesc:
        "Complete redesign of Dashboard and Popups for a premium look.",
      safetyFeatures: "Safety Features",
      safetyFeaturesDesc:
        "Force delete protection and safe history reset logic.",
      cloudBackup: "Cloud Backup",
      cloudBackupDesc:
        "Sync your data securely across devices with Google Drive integration.",
      multiCurrency: "Multi-Currency Support",
      multiCurrencyDesc:
        "Track expenses in multiple currencies with automatic conversion rates.",
      iosVersion: "iOS Version",
      iosVersionDesc:
        "Bringing Ollo to iPhone users with the same great features.",
      suggestionsTitle: "Have a Feature Request?",
      suggestionsText:
        "We love hearing from our users! Share your ideas and help shape the future of Ollo.",
    ...
    beta: {
      ...
      title2: "Beta Testing",
      subtitle:
        "Be among the first to experience Ollo and help shape the future of personal finance tracking. Get full premium access for free!",
      benefitsTitle: "Why Join the Beta?",
      benefit1Title: "Full Premium Access",
      benefit1Desc:
        "Get access to all premium features completely free as a thank you for being an early tester.",
      benefit2Title: "Exclusive Beta Badge",
      benefit2Desc:
        "Receive a special badge in the app that shows you're an early supporter of Ollo.",
      benefit3Title: "Direct Feedback Channel",
      benefit3Desc:
        "Share your thoughts directly with the developer. Your suggestions help improve the app.",
      ...
      noticeText:
        "Make sure to use the same Google email that you use on Google Play Store. Without this, you won't be able to install the beta app.",
      ...
      step1Desc:
        "Fill out the registration form with your Google Play email and preferences.",
      step2Title: "Get Added to Beta",
      step2Desc:
        "We'll add your email to the closed testing group on Google Play (usually within 24-48 hours).",
      step3Title: "Receive Invitation",
      step3Desc:
        "You'll get an Whatsapp invitation with a link to download Ollo from Play Store.",
      step4Title: "Start Testing!",
      step4Desc:
        "Download the app, explore all features, and share your feedback with us.",
    },
    testimonials: {
      label: "User Reviews",
      title1: "Loved by",
      title2: "thousands of users",
      subtitle: "Real reviews from real users on Google Play Store.",
      totalRatings: "downloads on Play Store",
      featuredReviews: "featured reviews",
      viewOnPlayStore: "See all reviews on Google Play",
    },
    common: {
  ...
  id: {
    ...
    footer: {
      ...
      description:
        "Aplikasi keuangan pribadi modern yang membantu Anda membangun kebiasaan uang yang lebih baik.",
      product: "Produk",
      company: "Perusahaan",
      legal: "Legal",
      features: "Fitur",
      ...
      copyright:
        "Ollo. Dibuat dengan ❤️ oleh Low Orbit Labs - Trian Aprilianto",
    ...
    home: {
      ...
      heroSubtitle:
        "Cukup bicara natural, dan Ollo langsung membuat transaksimu. Cara tercepat untuk mencatat uang.",
      ...
      spotlightSubtitle:
        "Cara tercepat mencatat pengeluaran. Bicara natural dalam bahasamu, dan AI Ollo langsung memahami jumlah, kategori, dan detail.",
      ...
      featuresSubtitle:
        "Fitur powerful yang dirancang dengan kesederhanaan. Lacak, analisis, dan optimalkan pengeluaranmu dengan mudah.",
      viewAllFeatures: "Lihat Semua Fitur →",
      smartTransactionsTitle: "Transaksi Cerdas",
      smartTransactionsDesc:
        "Catat pemasukan, pengeluaran, dan transfer dengan kategorisasi dan pencarian yang powerful.",
      multiWalletTitle: "Multi-Dompet",
      multiWalletDesc:
        "Kelola tunai, rekening bank, e-wallet, dan crypto dalam satu tempat.",
      richAnalyticsTitle: "Analitik Lengkap",
      richAnalyticsDesc:
        "Grafik dan insight cantik untuk memahami pola pengeluaranmu.",
      ...
      beautifulDesignDesc:
        "Antarmuka modern dan bersih yang membuat pencatatan keuangan menyenangkan.",
      freeForeverTitle: "Gratis Selamanya",
      freeForeverDesc:
        "Fitur esensial gratis. Premium membuka pengalaman penuh.",
    ...
    features: {
      ...
      subtitle:
        "Semua yang kamu butuhkan untuk mengendalikan keuanganmu. Lacak pengeluaran, analisis belanja, dan bangun kebiasaan uang yang lebih baik.",
      premium: "Premium",
      ...
      transactionManagementDesc:
        "Tambahkan transaksi pemasukan, pengeluaran, dan transfer dengan mudah. Edit tanggal, waktu, jumlah, kategori, dan catatan. Cari dan filter riwayat transaksi lengkap. Geser untuk hapus dengan dukungan undo.",
      multiWalletSystem: "Sistem Multi-Dompet",
      multiWalletSystemDesc:
        "Buat dompet tak terbatas untuk Tunai, Rekening Bank, E-Wallet, dan Crypto. Transfer antar dompet dengan pelacakan biaya. Pelacakan saldo per dompet dengan kustomisasi warna.",
      statisticsAnalytics: "Statistik & Analitik",
      statisticsAnalyticsDesc:
        "Tampilan mingguan, bulanan, dan tahunan dengan grafik cantik. Pie chart breakdown kategori, perbandingan pemasukan vs pengeluaran, dan kalkulasi pengeluaran harian rata-rata.",
      budgetManagement: "Manajemen Anggaran",
      budgetManagementDesc:
        "Atur anggaran bulanan per kategori dengan pelacakan progress dan indikator visual. Dapatkan peringatan over-budget dan tinjau riwayat anggaranmu.",
      savingsGoals: "Target Tabungan",
      savingsGoalsDesc:
        "Buat target tabungan dengan jumlah target. Setor atau tarik dengan shortcut persentase cepat (5%, 10%, 25%, 50%). Pelacakan progress visual dengan countdown tanggal target.",
      billsRecurring: "Tagihan & Berulang",
      billsRecurringDesc:
        "Jangan lewatkan pembayaran dengan pengingat tagihan. Berbagai offset pengingat (1 hari, 3 hari, 1 minggu sebelum). Atur transaksi berulang mingguan, bulanan, atau tahunan.",
      debtTracker: "Pelacak Hutang",
      debtTrackerDesc:
        "Lacak uang yang kamu utang (Payable) dan uang yang berhutang padamu (Receivable). Dukungan pembayaran sebagian dengan riwayat pembayaran dan pengingat jatuh tempo.",
      wishlist: "Wishlist",
      wishlistDesc:
        "Tambahkan item yang ingin kamu beli dengan level prioritas. Lacak harga target dan tandai sebagai dibeli — otomatis membuat transaksi.",
      cardGallery: "Galeri Kartu",
      cardGalleryDesc:
        "Koleksi kartu visual cantik untuk kartu Bank, E-Wallet, dan Blockchain. Tampilan nomor kartu tersamar, pelacakan kedaluwarsa, dan desain kartu custom.",
      reimbursementTracker: "Pelacak Reimbursement",
      reimbursementTrackerDesc:
        "Lacak pengeluaran bisnis untuk diklaim kembali. Pelacakan status (Pending, Approved, Paid) terhubung ke transaksi asli.",
      ...
      languagesSupportedDesc:
        "Ollo mendukung 7 bahasa, termasuk input suara dalam setiap bahasa.",
    },
    pricing: {
      badge: "Harga",
      ...
      subtitle:
        "Mulai gratis, upgrade saat butuh lebih. Semua paket termasuk fitur inti untuk mengelola uangmu lebih baik.",
      free: "Gratis",
      monthly: "Bulanan",
      sixMonth: "6-Bulan",
      annual: "Tahunan",
    ...
    download: {
      ...
      step1Desc:
        "Dapatkan Ollo dari Google Play Store. Gratis dan butuh kurang dari semenit.",
      step2Title: "Buat Dompetmu",
      step2Desc:
        "Atur dompet untuk tunai, rekening bank, atau e-wallet. Gunakan template untuk setup cepat.",
      step3Title: "Mulai Melacak",
      step3Desc:
        "Tambahkan transaksi pertamamu. Gunakan input suara untuk rekam cepat atau entri manual.",
      iosComingSoon: "iOS Segera Hadir",
      iosComingSoonDesc:
        "Kami sedang mengerjakan Ollo untuk iPhone. Ikuti kami di media sosial untuk update.",
    ...
    faq: {
      ...
      subtitle:
        "Temukan jawaban untuk pertanyaan umum tentang Ollo. Tidak menemukan yang kamu cari? Hubungi kami!",
      q1: "Is Ollo free to use?",
    ...
    about: {
      ...
      title2: "Ollo",
      subtitle:
        "Aplikasi keuangan pribadi yang dibuat dengan penuh perhatian, dirancang untuk membantu semua orang membangun kebiasaan uang yang lebih baik.",
      missionTitle: "Misi Kami",
      missionText:
        "Pencatatan uang seharusnya tidak menegangkan. Harus sederhana, cepat, dan manusiawi.",
      missionDesc:
        "Kami percaya bahwa setiap orang berhak mendapatkan gambaran jelas tentang keuangan mereka tanpa kompleksitas. Ollo dibuat untuk menjadi pendamping keuangan yang menghargai waktumu, melindungi privasimu, dan membantumu membuat keputusan yang lebih cerdas tentang uangmu — setiap hari.",
      ...
      userFocusedDesc:
        "Setiap fitur dibangun berdasarkan kebutuhan pengguna nyata. Kami mendengarkan masukan dan terus meningkatkan pengalaman.",
      sustainable: "Berkelanjutan",
      sustainableDesc:
        "Kami menawarkan tier gratis yang murah hati dan harga yang adil. Membangun sesuatu yang bertahan berarti membangun sesuatu yang berkelanjutan.",
      createdBy: "Dibuat oleh",
      at: "di",
      developerBio:
        "Developer indie dan maker yang passionate dalam membangun tools berguna yang membantu orang dalam kehidupan sehari-hari. Ollo adalah karya cinta, dibuat dengan perhatian terhadap detail dan komitmen terhadap kualitas.",
    ...
    credits: {
      ...
      title2: "Open Source",
      subtitle:
        "Ollo dibangun di atas bahu raksasa. Kami dengan syukur berterima kasih kepada tools dan library luar biasa yang membuat proyek ini mungkin.",
    ...
    roadmap: {
      ...
      vipCodeSystemDesc:
        "Badge eksklusif dan akses premium untuk pengguna spesial. Tukarkan kode VIP untuk keuntungan dan pengakuan unik.",
      freemiumQuickRecord: "Freemium Rekam Cepat",
      freemiumQuickRecordDesc:
        "Pengguna gratis sekarang dapat menggunakan 15 kali gratis untuk fitur Rekam Cepat Suara dan Scan.",
      premiumColorThemes: "Tema Warna Premium",
      premiumColorThemesDesc:
        "6 tema warna eksklusif untuk pengguna premium untuk mengkustomisasi pengalaman aplikasi.",
      keyboardAutoCapitalization: "Auto-Kapitalisasi Keyboard",
      keyboardAutoCapitalizationDesc:
        "Kapitalisasi teks cerdas untuk nama dan kalimat di kolom input.",
      appRestartBackupRestore: "Restart Aplikasi saat Restore",
      appRestartBackupRestoreDesc:
        "Restart aplikasi otomatis setelah memulihkan backup untuk pemulihan data yang mulus.",
      billDebtReminders: "Pengingat Cerdas",
      billDebtRemindersDesc:
        "Jangan lewatkan pembayaran dengan pengingat tanggal/waktu khusus untuk tagihan dan hutang.",
      globalCurrencySupport: "Dukungan Mata Uang Global",
      globalCurrencySupportDesc:
        "Dukungan untuk 160+ mata uang dengan nilai tukar real-time dan penyortiran cerdas.",
      onboardingGateway: "Gateway Onboarding",
      onboardingGatewayDesc:
        "Pengalaman sambutan baru dengan pemulihan backup terintegrasi untuk pengguna yang kembali.",
      themeSelectionScreen: "Kontrol Tema Lanjutan",
      themeSelectionScreenDesc:
        "Pemilihan tema khusus dengan preferensi terpisah untuk gaya kartu Mode Terang/Gelap.",
      darkModeCardThemes: "Tema Kartu Mode Gelap",
      darkModeCardThemesDesc:
        "10 tema kartu mode gelap baru yang memukau termasuk Nova, Eclipse, dan Aurora.",
      menuAppearanceSystem: "Tampilan Menu",
      menuAppearanceSystemDesc:
        "Personalisasi pengalamanmu dengan 28 tema warna preset baru untuk ikon menu dashboard.",
      performanceOptimizations: "Performa & Pemolesan",
      performanceOptimizationsDesc:
        "Startup lebih cepat, query database optimal, dan 138+ perbaikan UI untuk pengalaman yang lebih mulus.",
      backupSystemRedesign: "Sistem Backup Baru",
      backupSystemRedesignDesc:
        "Pengalaman backup yang lebih mudah menggunakan share sheet sistem tanpa izin penyimpanan khusus.",
      categoryReorder: "Atur Ulang Kategori",
      categoryReorderDesc:
        "Kustomisasi urutan kategori dengan drag & drop di Manajemen Kategori.",
      nullSafety: "ID Null-Safety",
      nullSafetyDesc:
        "Penegakan validasi ID global untuk mencegah anomali data.",
      performancePro: "Performa Pro",
      performanceProDesc:
        "Peningkatan besar untuk scrolling 60fps pada daftar panjang menggunakan RepaintBoundary.",
      multiPhoto: "Multi-Foto Lampiran",
      multiPhotoDesc:
        "Dukungan untuk beberapa lampiran foto per transaksi (Premium).",
      repaymentModule: "Modul Pembayaran Kembali",
      repaymentModuleDesc:
        "UI khusus untuk pembayaran kartu kredit dan pelacakan.",
      import2: "Impor 2.0",
      import2Desc:
        "Pemrosesan CSV lebih cerdas dengan mapping kategori sebelum impor.",
      edgeToEdge: "Dukungan Edge-to-Edge",
      edgeToEdgeDesc:
        "Dukungan UI Android 15 native dengan transparansi bottom-to-top.",
      glassmorphism: "UI Glassmorphism",
      glassmorphismDesc:
        "Redesain total Dashboard dan Popup untuk tampilan premium.",
      safetyFeatures: "Fitur Keamanan",
      safetyFeaturesDesc:
        "Perlindungan force delete dan logika reset riwayat yang aman.",
      cloudBackup: "Backup Cloud",
      cloudBackupDesc:
        "Sinkronkan data Anda dengan aman di berbagai perangkat dengan integrasi Google Drive.",
      multiCurrency: "Dukungan Multi-Mata Uang",
      multiCurrencyDesc:
        "Lacak pengeluaran dalam berbagai mata uang dengan konversi otomatis.",
      ...
      suggestionsText:
        "Kami senang mendengar dari pengguna! Bagikan ide Anda dan bantu bentuk masa depan Ollo.",
    ...
    beta: {
      ...
      title2: "Beta Testing",
      subtitle:
        "Jadilah yang pertama merasakan Ollo dan bantu bentuk masa depan pelacakan keuangan pribadi. Dapatkan akses premium penuh gratis!",
      benefitsTitle: "Kenapa Gabung Beta?",
      benefit1Title: "Akses Premium Penuh",
      benefit1Desc:
        "Dapatkan akses ke semua fitur premium secara gratis sebagai terima kasih karena menjadi tester awal.",
      benefit2Title: "Badge Beta Eksklusif",
      benefit2Desc:
        "Terima badge khusus di aplikasi yang menunjukkan kamu adalah pendukung awal Ollo.",
      benefit3Title: "Jalur Feedback Langsung",
      benefit3Desc:
        "Sampaikan pendapatmu langsung ke developer. Saranmu membantu memperbaiki aplikasi.",
      ...
      noticeTitle: "Penting!",
      noticeText:
        "Pastikan menggunakan email Google yang sama dengan yang kamu gunakan di Google Play Store. Tanpa ini, kamu tidak akan bisa menginstall aplikasi beta.",
      formTitle: "Daftar sebagai Beta Tester",
      formSubtitle:
        "Isi formulir di bawah untuk bergabung dengan program beta testing kami.",
      ...
      step1Desc:
        "Isi formulir pendaftaran dengan email Google Play dan preferensimu.",
      step2Title: "Ditambahkan ke Beta",
      step2Desc:
        "Kami akan menambahkan emailmu ke grup closed testing di Google Play (biasanya 24-48 jam).",
      step3Title: "Terima Undangan",
      step3Desc:
        "Kamu akan menerima Whatsapp undangan dengan link untuk download Ollo dari Play Store.",
      step4Title: "Mulai Testing!",
      step4Desc:
        "Download aplikasi, jelajahi semua fitur, dan bagikan feedback denganmu.",
    },
    testimonials: {
      label: "Ulasan Pengguna",
      title1: "Dipercaya",
      title2: "ribuan pengguna",
      subtitle: "Ulasan nyata dari pengguna nyata di Google Play Store.",
      totalRatings: "unduhan di Play Store",
      featuredReviews: "ulasan pilihan",
      viewOnPlayStore: "Lihat semua ulasan di Google Play",
    },
    common: {
